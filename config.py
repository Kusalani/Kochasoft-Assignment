...
class Settings(BaseSettings):
    NEO4J_URI: str = "neo4j+s://e512cfbf.databases.neo4j.io"
    NEO4J_USERNAME: str = "neo4j"
    NEO4J_PASSWORD: str = "ODBfwkcpnYUPX9qPwcRW65dIvn48S4PW2ZzPmzJu9C4"
    AURA_INSTANCEID: str = "e512cfbf"
    AURA_INSTANCENAME: str ="Free_instance"
